package com.touchdown.muchface.live.facedetectcamera.activity;
...
public final class FaceDetectGrayActivity extends AppCompatActivity
    ...
    switch (item.getItemId()) {
      ...
      case R.id.switchCam:
        ...
        if (numberOfCameras == 1) {
          ...
          builder.setTitle("Switch Camera")
              .setMessage("Your device have one camera")
  ...
  public void surfaceChanged(SurfaceHolder surfaceHolder, int format, int width, int height) {
    ...
    fdet = new android.media.FaceDetector(prevSettingWidth, (int) (prevSettingWidth * aspect),
        MAX_FACE);
    ...
    public void run() {
      ...
      for (int i = 0; i < MAX_FACE; i++) {
        if (fullResults[i] == null) {
          ...
          Rect rect = new Rect((int) (mid.x - eyesDis * 1.20f), (int) (mid.y - eyesDis * 0.55f),
              (int) (mid.x + eyesDis * 1.20f), (int) (mid.y + eyesDis * 1.85f));
          ...
          if (rect.height() * rect.width() > 100 * 100) {
            ...
            for (int j = 0; j < MAX_FACE; j++) {
              ...
              RectF rectCheck =
                  new RectF((midPre.x - eyesDisPre * 1.5f), (midPre.y - eyesDisPre * 1.15f),
                      (midPre.x + eyesDisPre * 1.5f), (midPre.y + eyesDisPre * 1.85f));
            ...
            faces_previous[i].set(faces[i].getId(), faces[i].getMidEye(), faces[i].eyesDistance(),
                faces[i].getConfidence(), faces[i].getPose(), faces[i].getTime());
